...
const Projects: React.FC<ProjectsProps> = ({ darkMode }) => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'An AI-powered Flask application that analyzes resumes and provides intelligent career recommendations. Features include smart resume parsing, AI-powered career matching, skills analysis, education history tracking, and precise career compatibility scoring with detailed growth pathways. Get personalized recommendations for top 3+ career paths that match your profile.',
